    ...
    <?php if(function_exists('lc_custom_header')) lc_custom_header(); else {
      ...
      if (get_theme_mod("enable_topbar") ) : ?>
        ...
        <div class="bg-dark py-2">
          ...
          <div class="main-text text-white">50% OFF on Making Charges on Gold Jewellery!</div>
          </div>
         </div>
        ...
        <div id="wrapper-navbar" itemscope itemtype="http://schema.org/WebSite">
          ...
          <nav class="navbar <?php echo get_theme_mod('picostrap_header_navbar_expand','navbar-expand-lg'); ?> <?php echo get_theme_mod('picostrap_header_navbar_position')." ". get_theme_mod('picostrap_header_navbar_color_scheme','navbar-light').' '. get_theme_mod('picostrap_header_navbar_color_choice','bg-white'); ?>" aria-label="Main Navigation" >
            <div class="container">
